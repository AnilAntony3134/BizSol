...
const MessageForm = ({ addMessage, message: { messages }, isSolution, auth: { me }, updateUserPreferences, closeHandler, isEdit }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values, { resetForm }) => {
      ...
      console.log('yeyeyey', parseInt(me.slots-1), me.slots)
      updateUserPreferences(me.id, { name: me.name, username: me.username, avatarpath: me.avatarpath, preferences: me.preferences, additionalInfo: me.additionalInfo, slots: me.slots-1});
      resetForm();
      closeHandler();
    },
  });
...
export default connect(mapStateToProps, { addMessage, addSolution, updateUserPreferences })(MessageForm);
